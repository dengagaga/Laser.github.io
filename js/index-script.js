document.addEventListener("DOMContentLoaded", function (event) {
  ...
  // document
  //   .querySelector(".table__title--1")
  //   .addEventListener("click", function () {
  //     document
  //       .querySelector(".price__table--1")
  //       .classList.toggle("price__table--active");
  //     document
  //       .querySelector(".table__arrow--1")
  //       .classList.toggle("table__arrow--green");
  //   });

  // document
  //   .querySelector(".table__title--2")
  //   .addEventListener("click", function () {
  //     document
  //       .querySelector(".price__table--2")
  //       .classList.toggle("price__table--active");
  //     document
  //       .querySelector(".table__arrow--2")
  //       .classList.toggle("table__arrow--green");
  //   });

  // document
  //   .querySelector(".table__title--3")
  //   .addEventListener("click", function () {
  //     document
  //       .querySelector(".price__table--3")
  //       .classList.toggle("price__table--active");
  //     document
  //       .querySelector(".table__arrow--3")
  //       .classList.toggle("table__arrow--green");
  //   });

  // document
  //   .querySelector(".table__title--4")
  //   .addEventListener("click", function () {
  //     document
  //       .querySelector(".price__table--4")
  //       .classList.toggle("price__table--active");
  //     document
  //       .querySelector(".table__arrow--4")
  //       .classList.toggle("table__arrow--green");
  //   });

  // document
  //   .querySelector(".table__title--5")
  //   .addEventListener("click", function () {
  //     document
  //       .querySelector(".price__table--5")
  //       .classList.toggle("price__table--active");
  //     document
  //       .querySelector(".table__arrow--5")
  //       .classList.toggle("table__arrow--green");
  //   });
  ...
  let reviewsButton1S = document.querySelector(
    ".reviews__slide--1 .slide__button--show"
  );
  let reviewsButton1H = document.querySelector(
    ".reviews__slide--1 .slide__button--hide"
  );
  let reviewsText1 = document.querySelector(
    ".reviews__slide--1 .slide__text--hidden"
  );
  showText(reviewsButton1S, reviewsButton1H, reviewsText1);

  let reviewsButton3S = document.querySelector(
    ".reviews__slide--3 .slide__button--show"
  );
  let reviewsButton3H = document.querySelector(
    ".reviews__slide--3 .slide__button--hide"
  );
  let reviewsText3 = document.querySelector(
    ".reviews__slide--3 .slide__text--hidden"
  );
  showText(reviewsButton3S, reviewsButton3H, reviewsText3);

  let reviewsButton5S = document.querySelector(
    ".reviews__slide--5 .slide__button--show"
  );
  let reviewsButton5H = document.querySelector(
    ".reviews__slide--5 .slide__button--hide"
  );
  let reviewsText5 = document.querySelector(
    ".reviews__slide--5 .slide__text--hidden"
  );
  showText(reviewsButton5S, reviewsButton5H, reviewsText5);

  let reviewsButton6S = document.querySelector(
    ".reviews__slide--6 .slide__button--show"
  );
  let reviewsButton6H = document.querySelector(
    ".reviews__slide--6 .slide__button--hide"
  );
  let reviewsText6 = document.querySelector(
    ".reviews__slide--6 .slide__text--hidden"
  );
  showText(reviewsButton6S, reviewsButton6H, reviewsText6);

  let reviewsButton7S = document.querySelector(
    ".reviews__slide--7 .slide__button--show"
  );
  let reviewsButton7H = document.querySelector(
    ".reviews__slide--7 .slide__button--hide"
  );
  let reviewsText7 = document.querySelector(
    ".reviews__slide--7 .slide__text--hidden"
  );
  showText(reviewsButton7S, reviewsButton7H, reviewsText7);

  let reviewsButton8S = document.querySelector(
    ".reviews__slide--8 .slide__button--show"
  );
  let reviewsButton8H = document.querySelector(
    ".reviews__slide--8 .slide__button--hide"
  );
  let reviewsText8 = document.querySelector(
    ".reviews__slide--8 .slide__text--hidden"
  );
  showText(reviewsButton8S, reviewsButton8H, reviewsText8);

  let reviewsButton9S = document.querySelector(
    ".reviews__slide--9 .slide__button--show"
  );
  let reviewsButton9H = document.querySelector(
    ".reviews__slide--9 .slide__button--hide"
  );
  let reviewsText9 = document.querySelector(
    ".reviews__slide--9 .slide__text--hidden"
  );
...
// const inv = document.querySelector('.block-ivisible')
// const adress2 = document.querySelector('.adress-2')


// adress2.addEventListener('', ()=> {
// 	inv.classList.toggle('inv')
// })


const priceBtn = document.querySelectorAll('.price__wrapper-table-all-btn')

const profitableСomplexes = document.querySelector('.profitable-complexes')
const faceAndNeck = document.querySelector('.Face-And-Neck')
...
priceBtn.forEach(btn => {
  btn.addEventListener('click', (e) => {
    priceBtn.forEach(el => {
      el.classList.remove('wrapper-table-all-btn-active')
    })
      btn.classList.toggle('wrapper-table-all-btn-active')
      if (btn.textContent == 'Выгодные комплексы') {
        profitableСomplexes.style.display = "block"
        faceAndNeck.style.display = "none"
        telo.style.display = "none"
        legs.style.display = "none"
        hands.style.display = "none"
        
      }
      else if (btn.textContent == 'Лицо и шея') {
        profitableСomplexes.style.display = "none"
        telo.style.display = "none"
        hands.style.display = "none"
        legs.style.display = "none"
        faceAndNeck.style.display = "block"
        
      }
      else if (btn.textContent == 'Тело') {
        profitableСomplexes.style.display = "none"
        faceAndNeck.style.display = "none"
        hands.style.display = "none"
        legs.style.display = "none"
...
const droplinks = document.querySelectorAll('.drowdown-link')
...
droplinks.forEach(link => {
  link.addEventListener('click', () => {
    ...
    if (link.textContent == 'Выгодные комплексы') {
      profitableСomplexes.style.display = "block"
      faceAndNeck.style.display = "none"
      telo.style.display = "none"
      legs.style.display = "none"
    ...
    else if (link.textContent == 'Лицо и шея') {
      profitableСomplexes.style.display = "none"
      telo.style.display = "none"
      hands.style.display = "none"
      legs.style.display = "none"
    ...
    else if (link.textContent == 'Выгодные комплексы ') {
      tableLPG1.style.display = "block"
        tableLPG2.style.display = "none"
        tableLPG3.style.display = "none"
      
    }
    else if (link.textContent == 'Абонемент на 5 процедур') {
      tableLPG1.style.display = "none"
      tableLPG3.style.display = "none"
        tableLPG2.style.display = "block"
      
    }
    else if (link.textContent == 'Абонемент на 10 процедур') {
      tableLPG1.style.display = "none"
        tableLPG2.style.display = "none"
        tableLPG3.style.display = "block"
...
const tableBtnLPG = document.querySelectorAll('.table-btn-LPG')
const tableLPG1 = document.querySelector('.LPG-table-1')
const tableLPG2 = document.querySelector('.LPG-table-2')
const tableLPG3 = document.querySelector('.LPG-table-3')


tableBtnLPG.forEach(btnLpg => {
  btnLpg.addEventListener('click', function() {
      
      if(btnLpg.textContent == 'Выгодные комплексы ') {
      tableLPG1.style.display = "block"
        tableLPG2.style.display = "none"
        tableLPG3.style.display = "none"
      }
      else if(btnLpg.textContent == 'Абонемент на 5 процедур') {
      tableLPG1.style.display = "none"
      tableLPG3.style.display = "none"
        tableLPG2.style.display = "block"
      }
      else if(btnLpg.textContent == 'Абонемент на 10 процедур') {
      tableLPG1.style.display = "none"
        tableLPG2.style.display = "none"
        tableLPG3.style.display = "block"
      }
...
const podgotovkaBtn = document.querySelectorAll('.podgotovka_drop-all-btn')
const kio1 = document.querySelector('.kio-1')
const kio2 = document.querySelector('.kio-2')
const kio3 = document.querySelector('.kio-3')
const kio4 = document.querySelector('.kio-4')
const imgDrop1 = document.querySelector('.img-drop-item1')
const imgDrop2 = document.querySelector('.img-drop-item2')
const imgDrop3 = document.querySelector('.img-drop-item3')
const imgDrop4 = document.querySelector('.img-drop-item4')

podgotovkaBtn.forEach(drop => {
  drop.addEventListener('click', function() {
    if(drop.textContent == 'Подготовка к процедуре') {
        kio1.classList.toggle('nob')
        imgDrop1.classList.toggle('rotate45deg')
      }
      else if (drop.textContent == 'О процедуре LPG-массажа') {
        kio2.classList.toggle('nob')
        imgDrop2.classList.toggle('rotate45deg')

      }
      else if (drop.textContent == 'Противопоказания для процедуры') {
        kio3.classList.toggle('nob')
        imgDrop3.classList.toggle('rotate45deg')

      }
      else if (drop.textContent == 'Рекомендуем после процедуры') {
        kio4.classList.toggle('nob')
        imgDrop4.classList.toggle('rotate45deg')
